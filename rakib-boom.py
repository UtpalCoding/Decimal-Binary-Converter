...
\033[1;91m\033[1;41m\033[1;97m              WELCOME TO SMS TOOLS  BY RAKIBUL             \033[;0m\033[1;91m\033[1;92m

\033[1;32m[-] TOOLS TYPE:\033[1;32m FREE

\033[1;32m[-] AUTHOR    :\033[1;32m rakibul islam 

\033[1;32m[-] GITHUB    :\033[1;32m mueor

\033[1;32m[-] FACEBOOK  :\033[1;32m rakibul islam rakib
...
if 'RAKIB'==user and 'RAKIB'==pas:

 Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL JOIN MY FB ")

 os.system('https://www.facebook.com/MUEOR')
...
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH RAKIB BAE ;) {w}<{r}/{w}>\n\n")
...
os.system("xdg-open https://youtube.com/@mueor")
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥RAKIB BAE🔥 "+w+tim)
